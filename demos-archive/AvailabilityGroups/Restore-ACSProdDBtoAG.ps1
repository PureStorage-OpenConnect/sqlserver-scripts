<#
Restore-ACSProdDBToAG.ps1

: Revision 1.0.0.0
:: initial release

Example script to restore the latest SQL Server database that was backed up via an application consistent snapshot using the Pure Storage Backup SSMS extension and add it to an Availability Group.
...
Requirements:
  SQL Server 2016 or later is required to utilize automatic seeding.
...
.NOTES
  ...
  Thanks go to Frank Gill for original code.
